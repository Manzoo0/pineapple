...
#include "PineappleInteractiveTool.generated.h"


/**
 * Builder for UPineappleInteractiveTool
 */
UCLASS()
class PINEAPPLE_API UPineappleInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UPineappleInteractiveTool
 */
UCLASS(Transient)
class PINEAPPLE_API UPineappleInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UPineappleInteractiveToolProperties();
...
/**
 * UPineappleInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class PINEAPPLE_API UPineappleInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UPineappleInteractiveToolProperties> Properties;
