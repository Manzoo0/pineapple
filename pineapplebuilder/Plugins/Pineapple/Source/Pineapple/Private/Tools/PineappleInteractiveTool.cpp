...
#include "PineappleInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UPineappleInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UPineappleInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UPineappleInteractiveTool* NewTool = NewObject<UPineappleInteractiveTool>(SceneState.ToolManager);
...
UPineappleInteractiveToolProperties::UPineappleInteractiveToolProperties()
{
...
void UPineappleInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UPineappleInteractiveTool::Setup()
{
	...
	Properties = NewObject<UPineappleInteractiveToolProperties>(this, "Measurement");
...
void UPineappleInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UPineappleInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UPineappleInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UPineappleInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UPineappleInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UPineappleInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UPineappleInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UPineappleInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UPineappleInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
